...
if(WIN32 AND NOT MSVC)
  set(EXTRA_MINGW_OPTIONS "-DCMAKE_CXX_FLAGS=-DABSL_FORCE_WAITER_MODE=4")
endif()
...
vcpkg_from_github(
  ...
  "${VERSION}"
  SHA512
  14390380655c41483a98487e3b012110dd8d1743fdd68d8cde7e0d7c2730312d564b15726d8c9d2fff237d2fce3983bbbb5213f59612c7c6feaeb402dff9609f
  HEAD_REF
  master)

vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS FEATURES cxx17
                     ABSL_USE_CXX17)
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
  ...
  foreach(header IN LISTS ${headers})
    vcpkg_replace_string("${header}" "!defined(ABSL_CONSUME_DLL)" "0")
    vcpkg_replace_string("${header}" "defined(ABSL_CONSUME_DLL)" "1")
  endforeach()
endif()
